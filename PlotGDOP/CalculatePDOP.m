function [GDOP, PDOP] = CalculatePDOP(Pseudolite, userPos)
% GDOP = delta(OutputLocateError) / delta(MeasuredData)

% Pseudolite{i} - struct with fields x, y, z
% userPos - array 1x3
% 
...
% for m = 1 : length(Pseudolite)
%    Pseudolite{m}.z = Pseudolite{m}.z + RE; 
% end
% userPos(3) = userPos(3) + RE;
