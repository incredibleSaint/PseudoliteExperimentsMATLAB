...
% clear;
% close all;
function Res = MainExp(MainParams)
%% УСТАНОВКА ЧАСТО ИЗМЕНЯЕМЫХ ПАРАМЕТРОВ
    ...
    % Флаг необходимости прорисовки результатов
        isDraw = 0; % 0 - не рисовать; 1 - рисовать; 2 - рисовать и
...
%% ПОДГОТОВИТЕЛЬНАЯ ЧАСТЬ
    ...
    % сигнала данных
        ...
        Params = struct(                                    ...
                        'sv_id', MainParams.sv_id,          ...
                        'threshold', MainParams.search_thrd ...
        );
